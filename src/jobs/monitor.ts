/**
 * 正式实验 - 每 30 分钟 tick 扫描所有 running 实验，按 t0_at 补采到点监控快照（Twitter 适配版）
 * ============================================================================
...
import { getTweet } from '../lib/twitter-api';
import {
  TwitterAccount,
  ExperimentRun,
  MONITOR_POINTS,
...
/** 采集指定实验在指定监控点的全部帖快照 */
async function capturePoint(experimentId: string, point: string, accounts: TwitterAccount[]): Promise<number> {
